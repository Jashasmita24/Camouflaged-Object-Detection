"""
Test/Evaluation Script for CODNet / UNet.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate CODNet / UNet")
    parser.add_argument("--checkpoint", type=str, required=True,
                        help="Path to model checkpoint")
    parser.add_argument("--model_type", type=str, default=None,
                        choices=["codnet", "unet"],
                        help="Model type (auto-detected from checkpoint if omitted)")
...
def main():
    ...
    # Detect model type from checkpoint or CLI arg
    model_type = args.model_type or ckpt.get("model_type", "codnet")
